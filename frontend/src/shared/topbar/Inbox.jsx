  ...
  return (
    <div className="notify-messages w-[450px] custom-shadow-white">
      <header className="header py-[10px] bg-bg2 z-20">
        <p className="text-center text-white text-[13px] font-medium">
        ...
        <li className="notify-item flex ">
          ...
          <div className="detail  ml-4 flex-grow">
            <div className="flex items-center justify-between mb-[10px] ">
              <h4 className="text-sm text-white font-medium">Movindu</h4>
              <span className="messaged-time text-xs text-gray-400">
                2 weeks ago
              </span>
            </div>
            <p className="message-text text-gray-300 text-xs break-words">
              Hii
            </p>
          </div>
        </li>
