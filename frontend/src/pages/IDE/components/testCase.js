...
const token = "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"; // Replace with process.env.TOKEN in real app
...
export const evaluateTestCases = async (question, code) => {
  try {
    ...
    const requestPayload = {
      messages: [
        ...
        {
          role: "user",
          content: `Evaluate the following code for the question: "${question}". If the code passes all test cases and is suitable for the question, respond with "true". Otherwise, respond with "false".\n\nCode:\n${code}`,
        },
      ],
      model: modelName,
    ...
    // Determine if the response indicates the code is suitable
